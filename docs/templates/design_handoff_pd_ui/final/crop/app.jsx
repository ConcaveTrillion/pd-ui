...
function App() {
  ...
  return (
    <>
      ...
      <DesignCanvas
        title="2 · Crop stage — final"
        subtitle="Auto-crops every page to the printed rectangle (dropping scanner margins, edge shadows, fingers). User reviews flagged pages, tunes per-page bboxes inline, or bulk re-runs with adjusted strategy. The loop the user spends most of their time in."
        sectionGap={64}
      >
        <DCSection
          id="Crop"
          title="Crop · Crop stage (wired up)"
