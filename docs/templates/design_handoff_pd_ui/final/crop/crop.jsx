      ...
      <div style={{
        ...
        {stale ? (
          <div style={{
            ...
            Settings changed — 21 downstream stages now stale
          </div>
        ) : null}
      </div>
    </div>
    ...
    <div style={{ padding: '20px 28px 28px', display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div style={{
        ...
        {[
          ...
          ['12 min ago', 'Source stage confirmed',     '387 pages forwarded'],
        ].map((row, i) => (
          <div key={i} style={{
            padding: '10px 16px',
...
const CropStepSettings = ({ state = 'default' }) => {
  ...
  return (
    <div style={{ padding: '20px 28px 28px', display: 'flex', flexDirection: 'column', gap: 14 }}>
      <div>
        <h2 style={{ fontSize: 16, fontWeight: 600, color: 'var(--ink-1)', letterSpacing: '-0.01em' }}>Stage settings · Crop</h2>
        <div style={{ marginTop: 3, fontSize: 12, color: 'var(--ink-3)' }}>
      ...
      {state === 'modified' ? (
        <div style={{
          ...
          <span style={{ fontSize: 12, color: 'var(--ink-1)' }}>
            Saving will mark Crop and <span className="mono" style={{ color: 'var(--fuzzy)', fontWeight: 600 }}>21 downstream stages</span> as stale.
          </span>
          <span style={{ flex: 1 }} />
