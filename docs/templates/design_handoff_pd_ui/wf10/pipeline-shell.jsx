...
const STAGE_DEFS = [
  ...
  { id: 'reorder',      short: 'reorder',     group: 'OCR' },
...
const ProjectConfigureFrame = ({ children, stripNode, theme = 'light', activeTab = 'pipeline' }) => (
    ...
    <main style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ padding: '14px 40px 0', borderBottom: '1px solid var(--border-1)' }}>
        <div style={{ display: 'flex', gap: 22 }}>
          <Tab label="Pipeline" active={activeTab === 'pipeline'} />
          <Tab label="Pages" count="387" active={activeTab === 'pages'} />
