 ...
 */
export const PageChip = React.forwardRef<HTMLDivElement, PageChipProps>(function PageChip(
  { id, isSelected, isPending, isDragging, children, className, onSelect, ...rest },
  forwardedRef,
) {
