...
export const WithForm: Story = {
  render: () => (
    <Popover>
      ...
      <PopoverContent>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-2)', padding: 'var(--space-2)', minWidth: '200px' }}>
          <label htmlFor="popover-confidence" style={{ fontSize: 'var(--text-sm)', color: 'var(--ink-2)' }}>
            Min confidence
          </label>
