...
const THREE_BLOCKS: BlockListItem[] = [
  {
    block_category: 'LINE',
    bounding_box: { top_left: { x: 0, y: 0 }, bottom_right: { x: 10, y: 5 } },
  },
  {
    block_category: 'LINE',
    bounding_box: { top_left: { x: 0, y: 10 }, bottom_right: { x: 10, y: 15 } },
  },
  {
    block_category: 'PARAGRAPH',
    bounding_box: { top_left: { x: 0, y: 20 }, bottom_right: { x: 10, y: 40 } },
  },
];
