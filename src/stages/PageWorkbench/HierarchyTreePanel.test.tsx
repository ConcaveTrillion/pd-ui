...
import { HIERARCHY_TREE_PANEL, treeRowTestId } from '../../testids/index.js';
...
function renderPanel(props: Partial<React.ComponentProps<typeof HierarchyTreePanel>> = {}) {
  return render(<HierarchyTreePanel tree={SIMPLE_TREE} {...props} />);
}
...
describe('HierarchyTreePanel', () => {
  ...
  it('forwards data-testid to outer container', () => {
    ...
    expect(document.querySelector('[data-testid="custom-tree"]')?.getAttribute('role')).toBe(
      'tree',
    );
  });
