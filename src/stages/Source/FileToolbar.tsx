 ...
 */
export const FileToolbar = React.forwardRef<HTMLDivElement, FileToolbarProps>(function FileToolbar(
  { filter, onFilterChange, counts, density, onDensityChange, onInsert, 'data-testid': testId },
  ref,
) {
  return (
    <div
    ...
    >
      ...
      {onInsert !== undefined ? (
        <div className="file-toolbar__actions">
          <Button size="sm" onClick={onInsert} data-testid="file-toolbar-insert">
            Insert page
          </Button>
        </div>
      ) : null}
